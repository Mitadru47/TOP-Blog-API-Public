        ...
        <div id="comment-creator">
            ...
            <div id="form-container">
                ...
                <form onSubmit={(event) => handleSubmit(event, post[0]._id)}>
                    ...
                    <textarea id="body-input" name="body" cols="150" rows="4" defaultValue="" placeholder="Comment"></textarea>
                    
                    <br></br>
                
                    <input id="username-input" type="text" name="username" defaultValue="" placeholder="Username"></input>
                    <input id="email-input" type="email" name="email" defaultValue="" placeholder="Email"></input>
